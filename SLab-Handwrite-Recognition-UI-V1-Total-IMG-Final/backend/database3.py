...
class dataBase:
    ...
    def create_connection(self):
        self.conn = sqlite3.connect("database3.db")
        self.cur = self.conn.cursor()

        # self.sql_command = """CREATE TABLE camera6(Serial INTEGER PRIMARY KEY, Height INTEGER, Width INTEGER , Gain INTEGER, Exposure INTEGER, offsetX INTEGER, offsetY INTEGER  )"""
